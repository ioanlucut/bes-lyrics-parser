...
shapeProperties.prototype.getDefault = function () {
  return XmlNode()
    ...
    .addChld(
      'a:prstGeom',
      XmlNode().attr({ prst: 'ellipse' }).addChild('a:avList', XmlNode()),
    );
