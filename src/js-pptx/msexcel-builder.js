...
(function () {
  ...
  ContentTypes = (function () {
    ...
    ContentTypes.prototype.toxml = function () {
      ...
      for (
        i = _i = 1, _ref = this.book.sheets.length;
  ...
  Sheet = (function () {
    function Sheet(book, name, cols, rows) {
      ...
      this.data = {};
      for (
        i = _i = 1, _ref = this.rows;
        1 <= _ref ? _i <= _ref : _i >= _ref;
        i = 1 <= _ref ? ++_i : --_i
      ) {
        this.data[i] = {};
        for (
          j = _j = 1, _ref1 = this.cols;
    ...
    Sheet.prototype.toxml = function () {
      ...
      for (
        ...
        for (
          j = _k = 1, _ref2 = this.cols;
          1 <= _ref2 ? _k <= _ref2 : _k >= _ref2;
          j = 1 <= _ref2 ? ++_k : --_k
        ) {
          ix = this.data[i][j];
  ...
  Workbook = (function () {
    ...
    Workbook.prototype.generate = function (cb) {
      ...
      for (
        i = _i = 0, _ref = this.sheets.length;
        0 <= _ref ? _i < _ref : _i > _ref;
        i = 0 <= _ref ? ++_i : --_i
      ) {
        zip.file(
