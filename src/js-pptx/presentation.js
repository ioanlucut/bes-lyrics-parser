...
Presentation.prototype.registerChart = function (chartName, content) {
  ...
  var defaults = this.content['[Content_Types].xml']['Types']['Default'].filter(
    function (el) {
...
Presentation.prototype.registerChartWorkbook = function (
  chartName,
  workbookContent,
) {
  ...
  this.content['ppt/charts/_rels/' + chartName + '.xml.rels'] =
    XmlNode().setChild(
      'Relationships',
      XmlNode()
        .attr({
...
Presentation.prototype.addSlide = function (layoutName) {
  ...
  var rId =
    'rId' +
    (this.content['ppt/_rels/presentation.xml.rels']['Relationships'][
      'Relationship'
    ].length +
      1);
  this.content['ppt/_rels/presentation.xml.rels']['Relationships'][
  ...
  var maxId = 0;
  this.content['ppt/presentation.xml']['p:presentation']['p:sldIdLst'][0][
    'p:sldId'
  ].forEach(function (ob) {
